...
function getTemplate() {
  ...
  const presets = {
    gaming: {
      filter: 'contrast(1.2) saturate(1.15) brightness(0.9)',
      shake: { max: 10, decay: 0.82, cooldown: 0.35 },
      zoom: { max: 0.12, decay: 0.85, cooldown: 0.25 },
      flash: { maxOpacity: 0.35, decay: 0.78 },
      vignette: false,
      transition: { frames: 3, opacity: 0.5 },
      tiers: {
        1: { shake: 10, flash: 0.35, zoom: 0.12 },
        2: { shake: 6, flash: 0.2, zoom: 0.06 },
        3: { flash: 0.1, zoom: 0.02 },
        4: { flash: 0.05 },
      },
    },
    cinematic: {
      filter: 'contrast(1.15) saturate(1.08) brightness(0.87)',
      shake: { max: 4, decay: 0.88, cooldown: 1.0 },
      zoom: { max: 0.06, decay: 0.9 },
      flash: { maxOpacity: 0.22, decay: 0.82 },
      vignette: true,
      transition: { frames: 6, opacity: 1 },
      tiers: {
        1: { flash: 0.18, zoom: 0.05 },
        2: { flash: 0.1, zoom: 0.03 },
        3: { flash: 0.06 },
        4: { flash: 0.03 },
      },
    },
    fast: {
      filter: 'contrast(1.2) saturate(1.25) brightness(0.92)',
      shake: { max: 12, decay: 0.78, cooldown: 0.3 },
      zoom: { max: 0.15, decay: 0.82 },
      flash: { maxOpacity: 0.4, decay: 0.75 },
      vignette: false,
      transition: { frames: 2, opacity: 0.35 },
      tiers: {
        1: { shake: 12, flash: 0.4, zoom: 0.15 },
        2: { shake: 8, flash: 0.25, zoom: 0.08 },
        3: { flash: 0.12, zoom: 0.03 },
        4: { flash: 0.05 },
      },
    },
    viral: {
      filter: 'contrast(1.3) saturate(1.35) brightness(0.93)',
      shake: { max: 14, decay: 0.76, cooldown: 0.25 },
      zoom: { max: 0.18, decay: 0.8 },
      flash: { maxOpacity: 0.45, decay: 0.72 },
      vignette: true,
      transition: { frames: 2, opacity: 0.4 },
      tiers: {
        1: { shake: 14, flash: 0.45, zoom: 0.18 },
        2: { shake: 9, flash: 0.28, zoom: 0.1 },
        3: { flash: 0.14, zoom: 0.04 },
        4: { flash: 0.06 },
      },
    },
    minimal: {
      filter: 'contrast(1.06) saturate(1.03) brightness(0.94)',
      shake: { max: 2, decay: 0.92, cooldown: 2 },
      zoom: { max: 0.03, decay: 0.93 },
      flash: { maxOpacity: 0.1, decay: 0.88 },
      vignette: true,
